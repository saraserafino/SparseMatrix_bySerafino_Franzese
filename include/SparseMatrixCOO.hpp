...
public:
    ...
    double& operator()(int row_idx, int col_idx) override; // overload secondo il suo metodo di salvare i valori
    double operator()(int row_idx, int col_idx) const override;
